...
85     config\_list = [c \textcolor{keywordflow}{for} c \textcolor{keywordflow}{in} rd\_configs.itervalues() \textcolor{keywordflow}{if} c[\textcolor{stringliteral}{'builder'}] != \textcolor{stringliteral}{'rosmake'}]
