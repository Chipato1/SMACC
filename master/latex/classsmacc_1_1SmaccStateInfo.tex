...
\item 
std\+::map$<$ std\+::string, std\+::shared\+\_\+ptr$<$ \hyperlink{classsmacc_1_1SmaccStateInfo}{Smacc\+State\+Info} $>$ $>$ \hyperlink{classsmacc_1_1SmaccStateInfo_a289bfe2ac475018ed0003423c2f59f84}{transitions\+\_\+}
\item 
...
\begin{DoxyCode}
319 \{
320     \textcolor{keyword}{auto} childState = this->\hyperlink{classsmacc_1_1SmaccStateInfo_af9884b3fda41fbc87abf9908b8bd72e7}{stateMachine\_}->createState<StateType>(shared\_from\_this());
321     \textcolor{comment}{//this->stateMachine\_->addState(childState);}
322     \textcolor{comment}{//stateMachineInfo.addState(stateMachineInfo)}
323     \textcolor{comment}{//stateNames.push\_back(currentname);}
324     \textcolor{comment}{//ROS\_INFO("------------");}
325     \textcolor{comment}{//ROS\_INFO\_STREAM("** STATE state: "<< this->demangledStateName);}
326 
327     \textcolor{keywordflow}{return} childState;
328 \}
\end{DoxyCode}
...
174     \hyperlink{classsmacc_1_1SmaccStateInfo_a289bfe2ac475018ed0003423c2f59f84}{transitions\_}[evtype] = dstState;
175 \}
\end{DoxyCode}
...
\begin{DoxyCode}
38 \{ \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1SmaccStateInfo_a3f44d5af069d0f37ed63b3101b330a65}{depth\_}; \}
\end{DoxyCode}
...
Definition at line 30 of file smacc\+\_\+state\+\_\+info.\+h.
