...
Definition at line 55 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.



References smacc\+::\+Orthogonal\+::set\+State\+Machine().


\begin{DoxyCode}
56 \{
57     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a5c8d4c9a4b11c7950266a00e48080ce3}{lockStateMachine}(\textcolor{stringliteral}{"create orthogonal"});
58     std::string orthogonalkey = demangledTypeName<TOrthogonal>();
59 
60     \textcolor{keywordflow}{if} (\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_}.count(orthogonalkey) == 0)
61     \{
62         \textcolor{keyword}{auto} ret = std::make\_shared<TOrthogonal>();
63         \hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_}[orthogonalkey] = dynamic\_pointer\_cast<
      \hyperlink{classsmacc_1_1Orthogonal}{smacc::Orthogonal}>(ret);
64 
65         ret->\hyperlink{classsmacc_1_1Orthogonal_a05f65c01344a6c8593f7f88c0ca19654}{setStateMachine}(\textcolor{keyword}{this});
66 
67         ROS\_INFO(\textcolor{stringliteral}{"%s Orthogonal is created"}, orthogonalkey.c\_str());
68     \}
69     \textcolor{keywordflow}{else}
70     \{
71         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"There were already one existing orthogonal of type "} << orthogonalkey.c\_str() << \textcolor{stringliteral}{"
      . Skipping creation orthogonal request. "});
72         std::stringstream ss;
73         ss << \textcolor{stringliteral}{"The existing orthogonals are the following: "} << std::endl;
74         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &orthogonal : orthogonals\_)
75         \{
76             ss << \textcolor{stringliteral}{" - "} << orthogonal.first << std::endl;
77         \}
78         ROS\_WARN\_STREAM(ss.str());
79     \}
80     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae2e3ceb87bfe3f9d8bf320e36071fdc7}{unlockStateMachine}(\textcolor{stringliteral}{"create orthogonal"});
81 \}
\end{DoxyCode}
...
References smacc\+::\+Bind$<$ arity $>$\+::bindaux().
...
\begin{DoxyCode}
254 \{
255     static\_assert(std::is\_base\_of<ISmaccState, TSmaccObjectType>::value || 
...
256 
257     \textcolor{keyword}{typedef} decltype(callback) ft;
258     Bind<\hyperlink{namespaceboost}{boost}::function\_types::function\_arity<ft>::value> binder;
259     \hyperlink{namespaceboost}{boost}::signals2::connection connection = binder.bindaux(signal, callback, \textcolor{keywordtype}{object});
260 
261     if (std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value)
262     \{
263     \}
264     \textcolor{keywordflow}{else} \textcolor{comment}{// state life-time objects}
265     \{
266         ROS\_WARN(\textcolor{stringliteral}{"[StateMachine] life-time constrained smacc signal subscription created"});
267         \hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections}.push\_back(connection);
268     \}
269     \textcolor{keywordflow}{return} connection;
270 \}
\end{DoxyCode}
...
\begin{DoxyCode}
274 \{
275     \textcolor{keywordflow}{return} signal.connect(callback);
276     \textcolor{comment}{// return signal;}
277 \}
\end{DoxyCode}
...
Definition at line 152 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
153 \{
154     std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
155     \textcolor{comment}{//ROS\_WARN("get SM Data lock acquire");}
156     \textcolor{keywordtype}{bool} success = \textcolor{keyword}{false};
157 
158     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}.count(name))
159     \{
160         \textcolor{comment}{//ROS\_WARN("get SM Data - data do not exist");}
161         success = \textcolor{keyword}{false};
162     \}
163     \textcolor{keywordflow}{else}
164     \{
165         \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. accessing");}
166         \textcolor{keywordflow}{try}
167         \{
168             \textcolor{keyword}{auto} &v = \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name];
169 
170             \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. any cast");}
171             ret = boost::any\_cast<T>(v.second);
172             success = \textcolor{keyword}{true};
173             \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. success");}
174         \}
175         \textcolor{keywordflow}{catch} (boost::bad\_any\_cast &ex)
176         \{
177             ROS\_ERROR(\textcolor{stringliteral}{"bad any cast: %s"}, ex.what());
178             success = \textcolor{keyword}{false};
179         \}
180     \}
181 
182     \textcolor{comment}{//ROS\_WARN("get SM Data lock release");}
183     \textcolor{keywordflow}{return} success;
184 \}
\end{DoxyCode}
...
Definition at line 22 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
23 \{
24     std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
25 
26     std::string orthogonalkey = demangledTypeName<TOrthogonal>();
27     TOrthogonal *ret;
28 
29     \textcolor{keyword}{auto} it = \hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_}.find(orthogonalkey);
30 
31     \textcolor{keywordflow}{if} (it != \hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_}.end())
32     \{
33         ROS\_INFO(\textcolor{stringliteral}{"%s resource is required. Found resource in cache."}, orthogonalkey.c\_str());
34         ret = \textcolor{keyword}{dynamic\_cast<}TOrthogonal *\textcolor{keyword}{>}(it->second.get());
35         \textcolor{keywordflow}{return} ret;
36     \}
37     \textcolor{keywordflow}{else}
38     \{
39         std::stringstream ss;
40         ss << \textcolor{stringliteral}{"Orthogonal not found "} << orthogonalkey.c\_str() << std::endl;
41         ss << \textcolor{stringliteral}{"The existing orthogonals are the following: "} << std::endl;
42         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &orthogonal : \hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
43         \{
44             ss << \textcolor{stringliteral}{" - "} << orthogonal.first << std::endl;
45         \}
46 
47         ROS\_WARN\_STREAM(ss.str());
48 
...
\begin{DoxyCode}
281 \{
282     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.getParam(param\_name, param\_storage);
283 \}
\end{DoxyCode}
...
Referenced by smacc\+::\+Signal\+Detector\+::poll\+Once(), and smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::$\sim$\+Smacc\+State().
...
Definition at line 207 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
208 \{
209     std::string stateFieldName = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(StateField).name());
210     std::string behaviorType = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(BehaviorType).name());
211     ROS\_INFO(\textcolor{stringliteral}{"Mapping state field '%s' to stateBehavior '%s'"}, stateFieldName.c\_str(), behaviorType.c\_str()
      );
212     SmaccClientBehavior *globalreference;
213     \textcolor{keywordflow}{if} (!this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(stateFieldName, globalreference))
214     \{
215         \textcolor{comment}{// Using the requires component approach, we force a unique existence}
216         \textcolor{comment}{// of this component}
217         BehaviorType *behavior;
218         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aa6b25e28f3bce24c4b356dc865a9eb7b}{requiresComponent}(behavior);
219         globalreference = \textcolor{keyword}{dynamic\_cast<}SmaccClientBehavior *\textcolor{keyword}{>}(behavior);
220 
221         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(stateFieldName, globalreference);
222     \}
223 \}
\end{DoxyCode}
...
\begin{DoxyCode}
314 \{
315     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
316     \{
317         ROS\_INFO(\textcolor{stringliteral}{"ortho onentry: %s"}, pair.second->getName().c\_str());
318         \textcolor{keyword}{auto} &orthogonal = pair.second;
319         orthogonal->onEntry();
320     \}
321 
322     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
323 \}
\end{DoxyCode}
...
Definition at line 300 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
301 \{
302 std:
303     lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
304 
305     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Entry, orthogonals:"} << this->
...
306 
307     \hyperlink{classsmacc_1_1ISmaccStateMachine_ab41ee07d20715142e2f7c92d551b2bd6}{stateSeqCounter\_}++;
308     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = state;
309     \hyperlink{classsmacc_1_1ISmaccStateMachine_a95e42f735cecdc231ad5372bf9fe7eaf}{currentStateInfo\_} = \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->getState<StateType>();
310 \}
\end{DoxyCode}
...
\begin{DoxyCode}
327 \{
328     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Exit: leaving state"} << state);
329     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
330     \{
331         \textcolor{keyword}{auto} &orthogonal = pair.second;
332         orthogonal->onExit();
333     \}
334 
335     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &conn : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections})
336     \{
337         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[StateMachine] Disconnecting scoped-lifetime SmaccSignal subscription"});
338         conn.disconnect();
339     \}
340 
341     this->stateCallbackConnections.clear();
342 
343     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = \textcolor{keyword}{nullptr};
344 \}
\end{DoxyCode}
...
Definition at line 294 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
295 \{
296     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.param(param\_name, param\_val, default\_val);
297 \}
\end{DoxyCode}
...
\begin{DoxyCode}
127 \{
128     std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
129 
130     \textcolor{comment}{// when a postting event is requested by any component, client, or client behavior}
131     \textcolor{comment}{// we reach this place. Now, we propagate the events to all the state logic units to generate}
132     \textcolor{comment}{// some more events}
133 
134     ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"[PostEvent entry point] "} << demangleSymbol<EventType>());
135     \textcolor{keyword}{auto} currentstate = \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_};
136     \textcolor{keywordflow}{if} (currentstate != \textcolor{keyword}{nullptr})
137     \{
138         \hyperlink{classsmacc_1_1ISmaccStateMachine_a268198b98e9540f4edb703801527a192}{propagateEventToLogicUnits}(currentstate, ev);
139     \}
140 
141     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a3982eb671f5f001cb047d3a467789986}{signalDetector\_}->\hyperlink{classsmacc_1_1SignalDetector_a6ab99d99cef8d101e39797a72daeb2b7}{postEvent}(ev);
142 \}
\end{DoxyCode}
...
Definition at line 145 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
146 \{
147     \textcolor{keyword}{auto} *ev = \textcolor{keyword}{new} EventType();
148     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a1549189caf29520514e677ca46f57348}{postEvent}(ev);
149 \}
\end{DoxyCode}
...
\begin{DoxyCode}
349 \{
350     ROS\_DEBUG(\textcolor{stringliteral}{"PROPAGATING EVENT [%s] TO LUs [%s]: "}, demangleSymbol<EventType>().c\_str(), st->getClassName
      ().c\_str());
351     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &lu : st->getLogicUnits())
352     \{
353         lu->notifyEvent(ev);
354     \}
355 
356     \textcolor{keyword}{auto} *pst = st->getParentState();
357     \textcolor{keywordflow}{if} (pst != \textcolor{keyword}{nullptr})
358     \{
359         \hyperlink{classsmacc_1_1ISmaccStateMachine_a268198b98e9540f4edb703801527a192}{propagateEventToLogicUnits}(pst, ev);
360     \}
361 \}
\end{DoxyCode}
...
Definition at line 85 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
Referenced by smacc\+::\+Smacc\+Client\+Behavior\+::requires\+Component().


\begin{DoxyCode}
86 \{
87     ROS\_DEBUG(\textcolor{stringliteral}{"component %s is required"}, \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(SmaccComponentType).name()).
      c\_str());
88     std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
89 
90     \textcolor{keywordflow}{for} (\hyperlink{Global_01Transition_01Rules_8txt_a2e1cdec29dad5013e514270d0a78fe22}{Orthogonal} *ortho : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
91     \{
92         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &client : ortho->getClients())
93         \{
94             storage = client->getComponent<SmaccComponentType>();
95             \textcolor{keywordflow}{if} (storage == \textcolor{keyword}{nullptr})
96             \{
...
100     \}
101 
102     \textcolor{comment}{// std::string componentkey = demangledTypeName<SmaccComponentType>();}
103     \textcolor{comment}{// SmaccComponentType *ret;}
104 
105     \textcolor{comment}{// auto it = components\_.find(componentkey);}
106 
107     \textcolor{comment}{// if (it == components\_.end())}
108     \textcolor{comment}{// \{}
109     \textcolor{comment}{//     ROS\_DEBUG("%s smacc component is required. Creating a new instance.", componentkey.c\_str());}
110 
111     \textcolor{comment}{//     ret = new SmaccComponentType();}
112     \textcolor{comment}{//     ret->setStateMachine(this);}
113     \textcolor{comment}{//     components\_[componentkey] = static\_cast<smacc::ISmaccComponent *>(ret);}
114     \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Done.", componentkey.c\_str());}
115     \textcolor{comment}{// \}}
116     \textcolor{comment}{// else}
117     \textcolor{comment}{// \{}
118     \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Found resource in cache.", componentkey.c\_str());}
119     \textcolor{comment}{//     ret = dynamic\_cast<SmaccComponentType *>(it->second);}
120     \textcolor{comment}{// \}}
121 
122     \textcolor{comment}{// storage = ret;}
123 \}
\end{DoxyCode}
...
Definition at line 187 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
188 \{
189     \{
190         std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
191         \textcolor{comment}{//ROS\_WARN("set SM Data lock acquire");}
192 
193         \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name] = \{
194             [\textcolor{keyword}{this}, name]() \{
195                 std::stringstream ss;
196                 \textcolor{keyword}{auto} val = any\_cast<T>(\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name].second);
197                 ss << val;
198                 \textcolor{keywordflow}{return} ss.str();
199             \},
200             value\};
201     \}
202 
203     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
204 \}
\end{DoxyCode}
...
Definition at line 287 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
288 \{
289     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.setParam(param\_name, param\_val);
290 \}
\end{DoxyCode}
...
Referenced by smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::get\+Full\+Path\+Name(), smacc\+::\+Smacc\+State\+Machine\+Base$<$ Sm\+Viewer\+Sim, Ms\+Run\+Mode $>$\+::initiate\+\_\+impl(), and state\+\_\+machine\+\_\+visualization().
