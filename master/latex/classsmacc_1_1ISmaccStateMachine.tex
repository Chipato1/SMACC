...
Definition at line 216 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
236 \{
237     \textcolor{keywordflow}{return} signal.connect(callback);
238     \textcolor{comment}{// return signal;}
239 \}
\end{DoxyCode}
...
\begin{DoxyCode}
143 \{
144     std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
145     \textcolor{comment}{//ROS\_WARN("get SM Data lock acquire");}
146     \textcolor{keywordtype}{bool} success = \textcolor{keyword}{false};
147 
148     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}.count(name))
149     \{
150         \textcolor{comment}{//ROS\_WARN("get SM Data - data do not exist");}
151         success = \textcolor{keyword}{false};
152     \}
153     \textcolor{keywordflow}{else}
154     \{
155         \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. accessing");}
156         \textcolor{keywordflow}{try}
157         \{
158             \textcolor{keyword}{auto} &v = \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name];
159 
160             \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. any cast");}
161             ret = boost::any\_cast<T>(v.second);
162             success = \textcolor{keyword}{true};
163             \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. success");}
164         \}
165         \textcolor{keywordflow}{catch} (boost::bad\_any\_cast &ex)
166         \{
167             ROS\_ERROR(\textcolor{stringliteral}{"bad any cast: %s"}, ex.what());
168             success = \textcolor{keyword}{false};
169         \}
170     \}
171 
172     \textcolor{comment}{//ROS\_WARN("get SM Data lock release");}
173     \textcolor{keywordflow}{return} success;
174 \}
\end{DoxyCode}
...
Definition at line 242 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
243 \{
244     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.getParam(param\_name, param\_storage);
245 \}
\end{DoxyCode}
...
Definition at line 197 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
198 \{
199     std::string stateFieldName = \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(StateField).name());
200     std::string behaviorType = \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(BehaviorType).name());
201     ROS\_INFO(\textcolor{stringliteral}{"Mapping state field '%s' to stateBehavior '%s'"}, stateFieldName.c\_str(), behaviorType.c\_str()
      );
202     SmaccClientBehavior *globalreference;
203     \textcolor{keywordflow}{if} (!this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(stateFieldName, globalreference))
204     \{
205         \textcolor{comment}{// Using the requires component approach, we force a unique existence}
206         \textcolor{comment}{// of this component}
207         BehaviorType *behavior;
208         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aa6b25e28f3bce24c4b356dc865a9eb7b}{requiresComponent}(behavior);
209         globalreference = \textcolor{keyword}{dynamic\_cast<}SmaccClientBehavior *\textcolor{keyword}{>}(behavior);
210 
211         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(stateFieldName, globalreference);
212     \}
213 \}
\end{DoxyCode}
...
Definition at line 275 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
276 \{
277     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
278     \{
279         ROS\_INFO(\textcolor{stringliteral}{"ortho onentry: %s"}, pair.second->getName().c\_str());
280         \textcolor{keyword}{auto} &orthogonal = pair.second;
281         orthogonal->onEntry();
282     \}
283 
284     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
285 \}
\end{DoxyCode}
...
Definition at line 262 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
289 \{
290     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Exit: leaving state"} << state);
291     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
292     \{
293         \textcolor{keyword}{auto} &orthogonal = pair.second;
294         orthogonal->onExit();
295     \}
296 
297     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &conn : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections})
298     \{
299         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[StateMachine] Disconnecting scoped-lifetime SmaccSignal subscription"});
300         conn.disconnect();
301     \}
302 
303     this->stateCallbackConnections.clear();
304 
305     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = \textcolor{keyword}{nullptr};
306 \}
\end{DoxyCode}
...
\begin{DoxyCode}
257 \{
258     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.param(param\_name, param\_val, default\_val);
259 \}
\end{DoxyCode}
...
Definition at line 120 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
80 \{
81     ROS\_DEBUG(\textcolor{stringliteral}{"component %s is required"}, \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(SmaccComponentType).name()).
      c\_str());
...
83 
84     \textcolor{keywordflow}{for}(\hyperlink{Global_01Transition_01Rules_8txt_a2e1cdec29dad5013e514270d0a78fe22}{Orthogonal}* ortho: this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_})
85     \{
86         \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}& client: ortho->getClients())
87         \{
88             storage = client->getComponent<SmaccComponentType>();
89             \textcolor{keywordflow}{if}(storage==\textcolor{keyword}{nullptr})
90             \{
...
94     \}
95 
96     \textcolor{comment}{// std::string componentkey = demangledTypeName<SmaccComponentType>();}
97     \textcolor{comment}{// SmaccComponentType *ret;}
98 
99     \textcolor{comment}{// auto it = components\_.find(componentkey);}
100 
101     \textcolor{comment}{// if (it == components\_.end())}
102     \textcolor{comment}{// \{}
103     \textcolor{comment}{//     ROS\_DEBUG("%s smacc component is required. Creating a new instance.", componentkey.c\_str());}
104 
105     \textcolor{comment}{//     ret = new SmaccComponentType();}
106     \textcolor{comment}{//     ret->setStateMachine(this);}
107     \textcolor{comment}{//     components\_[componentkey] = static\_cast<smacc::ISmaccComponent *>(ret);}
108     \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Done.", componentkey.c\_str());}
109     \textcolor{comment}{// \}}
110     \textcolor{comment}{// else}
111     \textcolor{comment}{// \{}
112     \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Found resource in cache.", componentkey.c\_str());}
113     \textcolor{comment}{//     ret = dynamic\_cast<SmaccComponentType *>(it->second);}
114     \textcolor{comment}{// \}}
115 
116     \textcolor{comment}{// storage = ret;}
117 \}
\end{DoxyCode}
...
\begin{DoxyCode}
250 \{
251     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.setParam(param\_name, param\_val);
252 \}
\end{DoxyCode}
