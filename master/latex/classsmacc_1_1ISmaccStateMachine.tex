...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{classsmacc_1_1ISmaccStateMachine_ad71ca51c9b46ccc013df766a1fcfe93f}{initialize\+Ros\+Components} ()
\item 
...
Definition at line 35 of file smacc\+\_\+state\+\_\+machine.\+h.
...
\begin{DoxyCode}
159 \{ \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_}; \};
\end{DoxyCode}
...
References create\+Orthogonal(), current\+State\+Info\+\_\+, initialize\+Ros\+Components(), and publish\+Transition().
...
\begin{DoxyCode}
161 \{ \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ac8ac420db18ed72cc0c7535f16c0aae8}{currentStateInfo\_}; \}
\end{DoxyCode}
...
Definition at line 73 of file smacc\+\_\+state\+\_\+machine.\+h.
...
\begin{DoxyCode}
74     \{
75         std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_a0eecb19258e0ec026029c7755dbb94d7}{m\_mutex\_});
76         \textcolor{comment}{//ROS\_WARN("get SM Data lock acquire");}
77         \textcolor{keywordtype}{bool} success = \textcolor{keyword}{false};
78 
79         \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}.count(name))
80         \{
81             \textcolor{comment}{//ROS\_WARN("get SM Data - data do not exist");}
82             success = \textcolor{keyword}{false};
83         \}
84         \textcolor{keywordflow}{else}
85         \{
86             \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. accessing");}
87             \textcolor{keywordflow}{try}
88             \{
89                 \textcolor{keyword}{auto} &v = \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name];
90 
91                 \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. any cast");}
92                 ret = boost::any\_cast<T>(v.second);
93                 success = \textcolor{keyword}{true};
94                 \textcolor{comment}{//ROS\_WARN("get SM DAta -data exist. success");}
95             \}
96             \textcolor{keywordflow}{catch} (boost::bad\_any\_cast &ex)
97             \{
98                 ROS\_ERROR(\textcolor{stringliteral}{"bad any cast: %s"}, ex.what());
99                 success = \textcolor{keyword}{false};
100             \}
101         \}
102 
103         \textcolor{comment}{//ROS\_WARN("get SM Data lock release");}
104         \textcolor{keywordflow}{return} success;
105     \}
\end{DoxyCode}
...
Definition at line 61 of file smacc\+\_\+state\+\_\+machine.\+h.
...
\begin{DoxyCode}
62     \{
63         \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8e5c25d0aecd91fe496df13751bc667}{orthogonals\_};
64     \}
\end{DoxyCode}
...
\begin{DoxyCode}
174     \{
175         \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.getParam(param\_name, param\_storage);
176     \}
\end{DoxyCode}
...
\begin{DoxyCode}
153     \{
154         \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(*this).name());
155     \}
\end{DoxyCode}
...
\index{smacc\+::\+I\+Smacc\+State\+Machine@{smacc\+::\+I\+Smacc\+State\+Machine}!initialize\+Ros\+Components@{initialize\+Ros\+Components}}
\index{initialize\+Ros\+Components@{initialize\+Ros\+Components}!smacc\+::\+I\+Smacc\+State\+Machine@{smacc\+::\+I\+Smacc\+State\+Machine}}
\subsubsection[{\texorpdfstring{initialize\+Ros\+Components()}{initializeRosComponents()}}]{\setlength{\rightskip}{0pt plus 5cm}void smacc\+::\+I\+Smacc\+State\+Machine\+::initialize\+Ros\+Components (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\hypertarget{classsmacc_1_1ISmaccStateMachine_ad71ca51c9b46ccc013df766a1fcfe93f}{}\label{classsmacc_1_1ISmaccStateMachine_ad71ca51c9b46ccc013df766a1fcfe93f}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsmacc_1_1ISmaccStateMachine_ad71ca51c9b46ccc013df766a1fcfe93f_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsmacc_1_1ISmaccStateMachine_ad71ca51c9b46ccc013df766a1fcfe93f_icgraph}
\end{center}
\end{figure}
...
Definition at line 129 of file smacc\+\_\+state\+\_\+machine.\+h.
...
\begin{DoxyCode}
130     \{
131         std::string stateFieldName = \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(StateField).name());
132         std::string behaviorType = \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(\textcolor{keyword}{typeid}(BehaviorType).name());
133         ROS\_INFO(\textcolor{stringliteral}{"Mapping state field '%s' to stateBehavior '%s'"}, stateFieldName.c\_str(), behaviorType.
      c\_str());
134         SmaccSubStateBehavior *globalreference;
135         \textcolor{keywordflow}{if} (!this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(stateFieldName, globalreference))
136         \{
137             \textcolor{comment}{// Using the requires component approach, we force a unique existence}
138             \textcolor{comment}{// of this component}
139             BehaviorType *behavior;
140             this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a729d0bcb3c4894e33f0696e0b1aeb155}{requiresComponent}(behavior);
141             globalreference = \textcolor{keyword}{dynamic\_cast<}SmaccSubStateBehavior *\textcolor{keyword}{>}(behavior);
142 
143             this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(stateFieldName, globalreference);
144         \}
145     \}
\end{DoxyCode}
...
\begin{DoxyCode}
188     \{
189         \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.param(param\_name, param\_val, default\_val);
190     \}
\end{DoxyCode}
...
113 
114             \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name] = \{
115                 [\textcolor{keyword}{this}, name]() \{
116                     std::stringstream ss;
117                     \textcolor{keyword}{auto} val = any\_cast<T>(\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name].second);
118                     ss << val;
...
122         \}
123 
124         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
125     \}
\end{DoxyCode}
...
\begin{DoxyCode}
181     \{
182         \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.setParam(param\_name, param\_val);
183     \}
\end{DoxyCode}
...
Referenced by get\+State\+Machine\+Name(), and initialize\+Ros\+Components().


\begin{DoxyCode}
121 \{
122 
123     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_a0eecb19258e0ec026029c7755dbb94d7}{m\_mutex\_});
124 
125     smacc\_msgs::SmaccStateMachine state\_machine\_msg;
126     state\_machine\_msg.states = \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->stateMsgs;
127     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_af4aa9fed70bd4c57b19e3370fbd25de7}{stateMachinePub\_}.publish(state\_machine\_msg);
128 
129     \hyperlink{classsmacc_1_1ISmaccStateMachine_a4f47dd614f12a95e7a3c46d465ce4b13}{status\_msg\_}.header.stamp = ros::Time::now();
130     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a55a7c7b26ad4dfea441c62c6326a5414}{stateMachineStatusPub\_}.publish(\hyperlink{classsmacc_1_1ISmaccStateMachine_a4f47dd614f12a95e7a3c46d465ce4b13}{status\_msg\_});
131 \}
\end{DoxyCode}
...
Definition at line 225 of file smacc\+\_\+state\+\_\+machine.\+h.
...
Referenced by get\+Param(), initialize\+Ros\+Components(), I\+Smacc\+State\+Machine(), param(), set\+Param(), and smacc\+::\+Smacc\+State\+Machine\+Base$<$ Timer\+State\+Machine, Timer\+State $>$\+::\+Smacc\+State\+Machine\+Base().
...
Definition at line 222 of file smacc\+\_\+state\+\_\+machine.\+h.
...
Referenced by smacc\+::\+Smacc\+State\+Machine\+Base$<$ Timer\+State\+Machine, Timer\+State $>$\+::\+Smacc\+State\+Machine\+Base(), and state\+\_\+machine\+\_\+visualization().
...
Referenced by smacc\+::\+Smacc\+State\+Machine\+Base$<$ Timer\+State\+Machine, Timer\+State $>$\+::\+Smacc\+State\+Machine\+Base(), state\+\_\+machine\+\_\+visualization(), and update\+Status\+Message().
...
Referenced by initialize\+Ros\+Components().
...
Referenced by publish\+Transition(), and smacc\+::\+Smacc\+State\+Machine\+Base$<$ Timer\+State\+Machine, Timer\+State $>$\+::\+Smacc\+State\+Machine\+Base().
