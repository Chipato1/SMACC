...
\textcolor{keyword}{struct }\hyperlink{structSimpleStateMachine}{SimpleStateMachine}
    : \textcolor{keyword}{public} \hyperlink{structsmacc_1_1SmaccStateMachineBase_a47508a2d301007546d4c70dedd2ade4b}{SmaccStateMachineBase}<SimpleStateMachine,ToolSimpleState>
\{
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keyword}{using} SmaccState::SmaccState;
  \textcolor{keywordtype}{void} \hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}()
  \{
    ROS\_INFO(\textcolor{stringliteral}{"Entering ToolSimpleState"});
  \}
\};

\textcolor{keywordtype}{int} \hyperlink{namespacerosdoc__lite_af17b2a5046f7827add27b1cc8deb06a0}{main}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char} **\hyperlink{namespacesmacc__viewer_a641e44a1c9c09b36c59a0651d01d4d97}{argv}) \{
  \textcolor{comment}{// initialize the ros node}
  ros::init(argc, argv, \textcolor{stringliteral}{"example1"});
  ros::NodeHandle \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh};
...
\begin{DoxyCode}
\textcolor{keyword}{struct }\hyperlink{structNavigate}{Navigate} : \hyperlink{classSmaccState}{SmaccState}<Navigate, SimpleStateMachine> 
\{
...
\textcolor{keyword}{public}:
  ...
  \hyperlink{classsmacc_1_1SmaccMoveBaseActionClient}{smacc::SmaccMoveBaseActionClient} *
      \hyperlink{structNavigate_a6ccf129ef69c3a8f664ecb8c367dae86}{moveBaseClient\_};
  ...
  \{
    ...
    this->\hyperlink{classsmacc_1_1SmaccState_ac986eddc8e7e552fd563b76a8f5ca908}{requiresComponent}(moveBaseClient\_);
    \hyperlink{structNavigate_a941523c9ba8391d3775d6b7f62fe1261}{goToEndPoint}();
  \}

  \textcolor{comment}{// auxiliar function that defines the motion that is requested to the move\_base action server}
  \textcolor{keywordtype}{void} \hyperlink{structNavigate_a941523c9ba8391d3775d6b7f62fe1261}{goToEndPoint}() \{
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keyword}{typedef} mpl::list<sc::transition<EvActionResult<SmaccMoveBaseActionClient::Result>, 
      \hyperlink{structExecuteToolState}{ExecuteToolState}>> \hyperlink{structNavigate_afdad91862c4900a993cc6e44309e807a}{reactions};
...
\textcolor{keyword}{struct }\hyperlink{structExecuteToolState}{ExecuteToolState} : \hyperlink{classSmaccState}{SmaccState}<ExecuteToolState, SimpleStateMachine>
\{
    \textcolor{keyword}{using} SmaccState::SmaccState;
    \textcolor{keywordtype}{void} \hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}()
    \{
...
\textcolor{keyword}{public}:
  ...
  \textcolor{comment}{// With this line we specify that we are going to react to any EvActionResult event}
  \textcolor{comment}{// generated by SMACC when the action server provides a response to our request}
  \textcolor{keyword}{typedef} mpl::list<sc::custom\_reaction<EvActionResult<SmaccMoveBaseActionClient::Result>>> 
      \hyperlink{structNavigate_afdad91862c4900a993cc6e44309e807a}{reactions};
  \textcolor{keyword}{using} SmaccState::SmaccState;
  \textcolor{keywordtype}{void} \hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}()
  \{
   [...]
  ...
  sc::result \hyperlink{structNavigate_ac058d0da392b7c5e1873702820595ae4}{react}(\textcolor{keyword}{const} EvActionResult<SmaccMoveBaseActionClient::Result> &ev)
  \{
...
\begin{DoxyCode}
\textcolor{keyword}{struct }\hyperlink{structNavigate}{Navigate} : \hyperlink{classSmaccState}{SmaccState}<Navigate, NavigationOrthogonalLine> 
\{
\textcolor{keyword}{public}:
  \textcolor{keyword}{using} SmaccState::SmaccState;
  \textcolor{keywordtype}{void} \hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}()
  \{
      ...
      \hyperlink{classsmacc_1_1ISmaccState_a4982f2187ed6da337462721146e8ef70}{param}(\textcolor{stringliteral}{"start\_position\_x"}, p.x, 0);
      \hyperlink{classsmacc_1_1ISmaccState_a4982f2187ed6da337462721146e8ef70}{param}(\textcolor{stringliteral}{"start\_position\_y"}, p.y, 0);
  \}
\}
\end{DoxyCode}
...
\textcolor{keyword}{public}:
  ...
  \{
        ...
        this->\hyperlink{classsmacc_1_1SmaccState_a98f2673b257479e0a3615d5d8279a591}{setGlobalSMData}(\textcolor{stringliteral}{"angle\_value"}, angle);
  \}
\};
...
\{
    ...
    \{
         ...
         this->\hyperlink{classsmacc_1_1SmaccState_ad53b5be2760eb7ffb50f3b2e542b65f1}{getGlobalSMData}(\textcolor{stringliteral}{"angle\_value"}, angle);
    \}
\};
\end{DoxyCode}
