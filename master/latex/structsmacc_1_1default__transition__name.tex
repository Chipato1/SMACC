...
\begin{center}
\leavevmode
\includegraphics[width=235pt]{structsmacc_1_1default__transition__name__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=235pt]{structsmacc_1_1default__transition__name__coll__graph}
\end{center}
\end{figure}
