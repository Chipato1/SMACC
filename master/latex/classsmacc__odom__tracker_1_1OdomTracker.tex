...
Definition at line 33 of file odom\+\_\+tracker.\+h.
...
Referenced by Sb\+Undo\+Path\+Backwards\+::on\+Entry(), and Undo\+Path\+Backwards\+::on\+Entry().


\begin{DoxyCode}
127 \{
128     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
129     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_};
130 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{init(ros\+::\+Node\+Handle \&nh, std\+::string) override}{init(ros::NodeHandle &nh, std::string) override}}]{\setlength{\rightskip}{0pt plus 5cm}void smacc\+\_\+odom\+\_\+tracker\+::\+Odom\+Tracker\+::init (
\begin{DoxyParamCaption}
\item[{ros\+::\+Node\+Handle \&}]{nh, }
\item[{std\+::string}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}\hypertarget{classsmacc__odom__tracker_1_1OdomTracker_aa4525024fdc01e54bc310f48c7676a2f}{}\label{classsmacc__odom__tracker_1_1OdomTracker_aa4525024fdc01e54bc310f48c7676a2f}


Must be called at the begining of the execution. 

\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_aa4525024fdc01e54bc310f48c7676a2f}{init()} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsmacc__odom__tracker_1_1OdomTracker_aa4525024fdc01e54bc310f48c7676a2f_cgraph}
\end{center}
\end{figure}
...
Definition at line 91 of file odom\+\_\+tracker.\+cpp.
...
\begin{DoxyCode}
92 \{
93     ROS\_INFO(\textcolor{stringliteral}{"odom\_tracker m\_mutex acquire"});
94     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
95     
96     \textcolor{keywordflow}{if}(!\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a6cdd5d1199cf4638d70a2232081ac076}{pathStack\_}.empty())
97     \{
98         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses = \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a6cdd5d1199cf4638d70a2232081ac076}{pathStack\_}.back().poses;
99         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a6cdd5d1199cf4638d70a2232081ac076}{pathStack\_}.pop\_back();
100     \}
101 
...
\begin{DoxyCode}
83 \{
84     ROS\_INFO(\textcolor{stringliteral}{"odom\_tracker m\_mutex acquire"});
85     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
86     \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a6cdd5d1199cf4638d70a2232081ac076}{pathStack\_}.push\_back(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_});
87     \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.clear();
88     ROS\_INFO(\textcolor{stringliteral}{"odom\_tracker m\_mutex release"});
89 \}
\end{DoxyCode}
...
\begin{DoxyCode}
138 \{
139     \textcolor{keywordflow}{if}(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a32d060919f2630e0695ce016c0563a3f}{robotBasePathPub\_}->trylock())
140     \{
141         nav\_msgs::Path& \hyperlink{namespacekeyboard__node_a768777e12f75b89e4a0a60acf748e9eb}{msg} = \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a32d060919f2630e0695ce016c0563a3f}{robotBasePathPub\_}->msg\_;
143 
144         msg = \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_};
145         msg.header.stamp = timestamp;
146         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a32d060919f2630e0695ce016c0563a3f}{robotBasePathPub\_}->unlockAndPublish();
147     \}
148 \}
\end{DoxyCode}
...
77     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
78     \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a5aaa7b76cae6ed70524d0f2ac04cbe70}{publishMessages} = value;
79     \textcolor{comment}{//ROS\_INFO("odom\_tracker m\_mutex release");}
80 \}
\end{DoxyCode}
...
\begin{DoxyCode}
114 \{
115     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
116     \textcolor{keywordflow}{if}(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.size() >0)
117     \{
118         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses[0]=pose;
119     \}
120     \textcolor{keywordflow}{else}
121     \{
122         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.push\_back(pose);
123     \}
124 \}
\end{DoxyCode}
...
Definition at line 61 of file odom\+\_\+tracker.\+cpp.
...
Referenced by Odom\+Tracker\+Action\+Server\+::execute(), Undo\+Path\+Backwards\+::on\+Entry(), Sb\+Undo\+Path\+Backwards\+::on\+Entry(), Navigate\+Global\+Position\+::on\+Entry(), Sb\+Navigate\+Global\+Position\+::on\+Entry(), Sb\+Navigate\+Forward\+::on\+Entry(), Navigate\+Forward\+::on\+Entry(), Sb\+Navigate\+Backwards\+::on\+Entry(), Sb\+Navigate\+Forward\+::on\+Exit(), and Sb\+Navigate\+Backwards\+::on\+Exit().


\begin{DoxyCode}
62 \{
63     \textcolor{comment}{//ROS\_INFO("odom\_tracker m\_mutex acquire");}
64     std::lock\_guard<std::mutex> lock(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad65e52bfd236e073940808c35f2bed8c}{m\_mutex\_});
65     \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ad011432ae35a533fd61bae43179c3c36}{workingMode\_} = workingMode;
66     \textcolor{comment}{//ROS\_INFO("odom\_tracker m\_mutex release");}
67 \}
\end{DoxyCode}
...
181     \}
182 
183     \textcolor{comment}{//ROS\_INFO("Backwards, last distance: %lf < %lf accept: %d", dist, minPointDistanceBackwardThresh\_,
       acceptBackward);}
...
210     \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.header = odom.header;
211 
212     \textcolor{keywordtype}{bool} enqueueOdomMessage = \textcolor{keyword}{false};
213 
214     \textcolor{keywordtype}{double} dist = -1;
215     \textcolor{keywordflow}{if}(\hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.empty())
216     \{
217         enqueueOdomMessage = \textcolor{keyword}{true};
218     \}
219     \textcolor{keywordflow}{else}
220     \{
221         \textcolor{keyword}{const} geometry\_msgs::Point& prevPoint = \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.back().pose.position;
222         \textcolor{keyword}{const} geometry\_msgs::Point& currePoint = base\_pose.pose.position;
223         dist = \hyperlink{namespacesmacc__odom__tracker_a93496d9bf987249b884e9b0e60778a11}{p2pDistance}(prevPoint, currePoint);
224         \textcolor{comment}{//ROS\_WARN("dist %lf vs min %lf", dist, minPointDistanceForwardThresh\_);}
225 
226         \textcolor{keywordflow}{if}(dist > \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_a0017d7740d99c2cc8ba946495b96ce41}{minPointDistanceForwardThresh\_})
227         \{
...
238     \{
239         \hyperlink{classsmacc__odom__tracker_1_1OdomTracker_ac3a17be46ab833632c5f63e75c840dc7}{baseTrajectory\_}.poses.push\_back(base\_pose);
240     \}
241 
...
Definition at line 87 of file odom\+\_\+tracker.\+h.
