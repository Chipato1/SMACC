...
15         \textcolor{comment}{//   static\_configure<KeyboardOrthogonal, SbKeyboard>();}
16         \textcolor{comment}{//   static\_configure<PublisherOrthogonal, SbStringPublisher>("Hello World!");}
17         \textcolor{comment}{//   static\_configure<SensorOrthogonal, SbConditionTemperatureSensor>();}
18         \textcolor{comment}{//   static\_configure<Service3Orthogonal, Service3Behavior>(Service3Command::SERVICE3\_ON);}
19 
20         static\_createLogicUnit<LuEventCountdown, EvCountdownEnd<LuEventCountdown>, 
      mpl::list<EvTimer<SmaccTimerClient>>>(5);
21 
22         \textcolor{comment}{//static\_createLogicUnit<LuEventCountdown, EvCountdownEnd<LuEventCountdown>,
