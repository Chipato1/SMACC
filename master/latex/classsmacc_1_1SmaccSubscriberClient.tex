...
\subsubsection[{\texorpdfstring{configure\+Event\+Source\+Types()}{configureEventSourceTypes()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Message\+Type$>$ template$<$typename T\+Derived , typename T\+Object\+Tag $>$ void {\bf smacc\+::\+Smacc\+Subscriber\+Client}$<$ Message\+Type $>$\+::configure\+Event\+Source\+Types (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
