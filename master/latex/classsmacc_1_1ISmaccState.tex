...
45     \{
46         \textcolor{keyword}{auto} smaccBehavior = std::shared\_ptr<TBehavior>(\textcolor{keyword}{new} TBehavior(args...));
47         smaccBehavior->template assignToOrthogonal<TBehavior, TOrthogonal>();
48         orthogonal->setStateBehavior(smaccBehavior);
49     \}
...
70     \{
71         ortho.second->requiresClient(storage, verbose);
...
\begin{DoxyCode}
59 \{
60     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a729d0bcb3c4894e33f0696e0b1aeb155}{requiresComponent}(storage);
61 \}
\end{DoxyCode}
