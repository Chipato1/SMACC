...
\begin{center}
\leavevmode
\includegraphics[width=306pt]{classsmacc_1_1ISmaccState__coll__graph}
\end{center}
\end{figure}
...
)}\hypertarget{classsmacc_1_1ISmaccState_aecb72f0a371a3973147aad38ab604b64}{}\label{classsmacc_1_1ISmaccState_aecb72f0a371a3973147aad38ab604b64}


Definition at line 37 of file smacc\+\_\+state\+\_\+impl.\+h.
...
40     ROS\_INFO(\textcolor{stringliteral}{"Configuring orthogonal: %s"}, orthogonalkey.c\_str());
41 
42     std::shared\_ptr<TOrthogonal> orthogonal;
43     \textcolor{keywordflow}{if} (this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a66a6732a48dbc0bc7a95b57fba5ec980}{getOrthogonal}<TOrthogonal>(orthogonal))
44     \{
45         orthogonal->setStateBehavior(smaccBehavior);
46     \}
47     \textcolor{keywordflow}{else}
48     \{
49         ROS\_ERROR(\textcolor{stringliteral}{"Skipping substate behavior creation. Orthogonal did not exist."});
50     \}
51 \}
\end{DoxyCode}
...
Definition at line 91 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
92 \{
93     \textcolor{keyword}{auto} lu = std::make\_shared<TLUnit>(args...);
94     TEventList* mock;
95     lu->initialize(\textcolor{keyword}{this}, mock);
96     lu->declarePostEvent(typelist<TTriggerEvent>());
97     \hyperlink{classsmacc_1_1ISmaccState_a21bb2f9adba9c86e3d5306fd1db99fcd}{logicUnits\_}.push\_back(lu);
98     \textcolor{keywordflow}{return} lu;
99 \}
\end{DoxyCode}
...
\begin{DoxyCode}
77 \{
78     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(name, ret);
79 \}
\end{DoxyCode}
...
Definition at line 14 of file smacc\+\_\+state\+\_\+impl.\+h.
...
Referenced by sm\+\_\+dance\+\_\+bot\+::\+Sb\+Navigate\+Global\+Position\+::read\+Start\+Pose\+From\+Parameter\+Server().


\begin{DoxyCode}
15 \{
16     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getParam(param\_name, param\_storage);
17 \}
\end{DoxyCode}
...
Definition at line 122 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
123 \{
124     \textcolor{keyword}{auto} transitionType = smacc::TypeInfo::getTypeInfoFromType<TransitionType>();
125     this->\hyperlink{classsmacc_1_1ISmaccState_a46ec42e07b8c68e8ddb7dd3472e91214}{notifyTransitionFromTransitionTypeInfo}(transitionType);
126 \}
\end{DoxyCode}
...
Referenced by sm\+\_\+dance\+\_\+bot\+::\+Sb\+Rotate\+::on\+Entry(), sm\+\_\+dance\+\_\+bot\+::\+Sb\+Navigate\+Forward\+::on\+Entry(), and sm\+\_\+dance\+\_\+bot\+::\+Sb\+Navigate\+Backwards\+::on\+Entry().


\begin{DoxyCode}
31 \{
32     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.param(param\_name, param\_val, default\_val);
33 \}
\end{DoxyCode}
...
\begin{DoxyCode}
116 \{
117     \hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad80cdd7bbc9a9f3b221c625754fed1ed}{postEvent}(ev);
118 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{requires\+Client(\+Smacc\+Client\+Type $\ast$\&storage, bool verbose=false)}{requiresClient(SmaccClientType *&storage, bool verbose=false)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Smacc\+Client\+Type $>$ void smacc\+::\+I\+Smacc\+State\+::requires\+Client (
\begin{DoxyParamCaption}
\item[{Smacc\+Client\+Type $\ast$\&}]{storage, }
\item[{{\bf bool}}]{verbose = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{classsmacc_1_1ISmaccState_a0f116de85bbc91d94e1eb2f74502acd8}{}\label{classsmacc_1_1ISmaccState_a0f116de85bbc91d94e1eb2f74502acd8}


Definition at line 62 of file smacc\+\_\+state\+\_\+impl.\+h.
...
Definition at line 55 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
56 \{
57     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a729d0bcb3c4894e33f0696e0b1aeb155}{requiresComponent}(storage);
58 \}
\end{DoxyCode}
...
Definition at line 84 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
85 \{
86     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(name, value);
87 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=342pt]{classsmacc_1_1ISmaccState_a0b6c531ca8c446052022308548f55b92_icgraph}
\end{center}
\end{figure}
