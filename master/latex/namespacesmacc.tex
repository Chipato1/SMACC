...
Definition at line 242 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
242                    \{
243    \textcolor{comment}{/* something when T has toString ... */}
244    ROS\_INFO\_STREAM(\textcolor{stringliteral}{"EXECUTING ONDEFINITION: "} << \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(T).name()));
245    T::onDefinition();
246 \}
\end{DoxyCode}
...
Definition at line 250 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
250                    \{
251     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"static OnDefinition: dont exist for "} << \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(T).name()
      ));
252    \textcolor{comment}{/* something when T has toString ... */}
253    
254 \}
\end{DoxyCode}
...
\begin{DoxyCode}
131 \{
132     WalkStatesExecutor<T>::walkStates(parentState, \textcolor{keyword}{false});
133 \}
\end{DoxyCode}
...
\begin{DoxyCode}
138 \{
139     \textcolor{keyword}{using} boost::mpl::\_1;
140     \textcolor{keyword}{using} wrappedList = \textcolor{keyword}{typename} boost::mpl::transform<T, add\_type\_wrapper<\_1>>::type;
141     boost::mpl::for\_each<wrappedList>(AddSubState(parentState));
142 \}
\end{DoxyCode}
...
158 
159     \textcolor{keywordflow}{if} (!sourceState->stateMachine\_->containsState<Dst>())
160     \{
161         \textcolor{keyword}{auto} siblingnode = sourceState->stateMachine\_->createState<Dst>(sourceState->parentState\_);
162         WalkStatesExecutor<Dst>::walkStates(siblingnode, \textcolor{keyword}{true});
163         sourceState->declareTransition<Ev>(siblingnode);
164     \}
165     \textcolor{keywordflow}{else}
166     \{
167         \textcolor{keyword}{auto} siblingnode = sourceState->stateMachine\_->getState<Dst>();
168         sourceState->declareTransition<Ev>(siblingnode);
169     \}
170 \}
\end{DoxyCode}
...
\begin{DoxyCode}
202 \{
203     \textcolor{comment}{//ROS\_INFO\_STREAM("GOTCHA");}
204 \}
\end{DoxyCode}
...
\begin{DoxyCode}
147 \{
148     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"State %s Walker has transition list"});
149     \textcolor{keyword}{using} boost::mpl::\_1;
150     \textcolor{keyword}{using} wrappedList = \textcolor{keyword}{typename} boost::mpl::transform<T, add\_type\_wrapper<\_1>>::type;
151     boost::mpl::for\_each<wrappedList>(AddTransition(sourceState));
152 \}
\end{DoxyCode}
\index{smacc@{smacc}!process\+Transitions@{process\+Transitions}}
\index{process\+Transitions@{process\+Transitions}!smacc@{smacc}}
...
\begin{DoxyCode}
209 \{
210     \textcolor{comment}{//ROS\_INFO\_STREAM("state transition from: " << sourceState->demangledStateName << " of type: " <<
       demangledTypeName<T>());}
211     T *dummy;
212     \hyperlink{namespacesmacc_a1f165532f9a9126db41900fbf23a985d}{processTransition}(dummy, sourceState);
213 \}
\end{DoxyCode}
