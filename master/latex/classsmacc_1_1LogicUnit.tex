...
Definition at line 19 of file logic\+\_\+unit.\+h.
...
\begin{DoxyCode}
79     \{
80         \textcolor{keyword}{const} \textcolor{keyword}{auto} *eventtype = &\textcolor{keyword}{typeid}(T);
81         this->\hyperlink{classsmacc_1_1LogicUnit_a29196899a02ed436e9ba68784b4d5cf4}{eventCallbacks\_}[eventtype] = [=](\textcolor{keywordtype}{void} *msg) \{
82             T *evptr = (T *)msg;
83             (\textcolor{keywordtype}{object}->*callback)(evptr);
84         \};
85     \}
\end{DoxyCode}
\index{smacc\+::\+Logic\+Unit@{smacc\+::\+Logic\+Unit}!create\+Event\+Callback@{create\+Event\+Callback}}
...
Definition at line 88 of file logic\+\_\+unit.\+h.


\begin{DoxyCode}
89     \{
90         \textcolor{keyword}{const} \textcolor{keyword}{auto} *eventtype = &\textcolor{keyword}{typeid}(T);
91         this->\hyperlink{classsmacc_1_1LogicUnit_a29196899a02ed436e9ba68784b4d5cf4}{eventCallbacks\_}[eventtype] = [=](\textcolor{keywordtype}{void} *msg) \{
92             T *evptr = (T *)msg;
93             callback(evptr);
94         \};
95     \}
...
Definition at line 7 of file smacc\+\_\+logic\+\_\+unit\+\_\+impl.\+h.
...
\begin{DoxyCode}
8 \{
9     this->\hyperlink{classsmacc_1_1LogicUnit_ac75aaeeea0e8d3667763a332ecfd65f7}{postEventFn} = [\textcolor{keyword}{this}]() \{
10         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"[Logic Unit Base] postingfn posting event: "} << demangleSymbol<TEv>());
11         \textcolor{keyword}{auto} *ev = \textcolor{keyword}{new} TEv();
12         this->\hyperlink{classsmacc_1_1LogicUnit_a8863d227f46868876632b07b500f27d6}{ownerState}->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad80cdd7bbc9a9f3b221c625754fed1ed}{postEvent}(ev);
13     \};
14 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsmacc_1_1LogicUnit_a76ef62bbd4dccf3da2c03032616b3ef6_cgraph}
\end{center}
\end{figure}
...
Definition at line 47 of file logic\+\_\+unit.\+h.


\begin{DoxyCode}
48     \{
49         this->\hyperlink{classsmacc_1_1LogicUnit_a8863d227f46868876632b07b500f27d6}{ownerState} = \hyperlink{classsmacc_1_1LogicUnit_a8863d227f46868876632b07b500f27d6}{ownerState};
50 
51         \textcolor{keyword}{using} boost::mpl::\_1;
52         \textcolor{keyword}{using} wrappedList = \textcolor{keyword}{typename} boost::mpl::transform<TEventList, \_1>::type;
53         AddTEventType<TEventList> op(\textcolor{keyword}{this});
54         boost::mpl::for\_each<wrappedList>(op);
55 
56         this->\hyperlink{classsmacc_1_1LogicUnit_ade7f409516683f13754943db1081bac0}{onInitialized}();
57     \}
\end{DoxyCode}
...
Definition at line 60 of file logic\+\_\+unit.\+h.


\begin{DoxyCode}
61     \{
62         \textcolor{keyword}{auto} tid = &(\textcolor{keyword}{typeid}(TEvent));
63         \textcolor{keywordflow}{if} (std::find(\hyperlink{classsmacc_1_1LogicUnit_a6f02a49da9b408b54a2755c18c5616a8}{eventTypes}.begin(), \hyperlink{classsmacc_1_1LogicUnit_a6f02a49da9b408b54a2755c18c5616a8}{eventTypes}.end(), tid) != 
      \hyperlink{classsmacc_1_1LogicUnit_a6f02a49da9b408b54a2755c18c5616a8}{eventTypes}.end())
64         \{
65             this->\hyperlink{classsmacc_1_1LogicUnit_a3a81929b2014b10d0fa28d4bc2d19d9c}{onEventNotified}(tid);
66             this->\hyperlink{classsmacc_1_1LogicUnit_afcec0608a17e039791403472a2411539}{update}();
67 
68             \textcolor{keywordflow}{if} (\hyperlink{classsmacc_1_1LogicUnit_a29196899a02ed436e9ba68784b4d5cf4}{eventCallbacks\_}.count(tid))
69             \{
70                 \hyperlink{classsmacc_1_1LogicUnit_a29196899a02ed436e9ba68784b4d5cf4}{eventCallbacks\_}[tid]((\textcolor{keywordtype}{void} *)ev);
71             \}
72         \}
73     \}
\end{DoxyCode}
...
Definition at line 24 of file logic\+\_\+unit.\+h.
