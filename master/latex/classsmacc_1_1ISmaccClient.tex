...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename T\+Derived , typename T\+Object\+Tag $>$ }\\void \hyperlink{classsmacc_1_1ISmaccClient_a643285b93f2bd33987e0d0d1a12caf10}{configure\+Event\+Source\+Types} ()
\end{DoxyCompactItemize}
\subsection*{Friends}
\begin{DoxyCompactItemize}
\item 
...
\subsubsection[{\texorpdfstring{configure\+Event\+Source\+Types()}{configureEventSourceTypes()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T\+Derived , typename T\+Object\+Tag $>$ void smacc\+::\+I\+Smacc\+Client\+::configure\+Event\+Source\+Types (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\begin{DoxyCode}
38 \{
39     \textcolor{keyword}{const} std::type\_info *componentkey = &\textcolor{keyword}{typeid}(SmaccComponentType);
40     std::shared\_ptr<SmaccComponentType> ret;
41 
42     \textcolor{keyword}{auto} it = \hyperlink{classsmacc_1_1ISmaccClient_ab983e85d296c9660f5943c1d511634ce}{components\_}.find(componentkey);
43 
44     \textcolor{keywordflow}{if} (it == \hyperlink{classsmacc_1_1ISmaccClient_ab983e85d296c9660f5943c1d511634ce}{components\_}.end())
45     \{
46         \textcolor{keyword}{auto} tname = demangledTypeName<SmaccComponentType>();
47         ROS\_DEBUG(\textcolor{stringliteral}{"%s smacc component is required. Creating a new instance."}, tname.c\_str());
48 
49         ret = std::shared\_ptr<SmaccComponentType>(\textcolor{keyword}{new} SmaccComponentType(targs...));
50         ret->initialize(\textcolor{keyword}{this});
51         ret->setStateMachine(\hyperlink{classsmacc_1_1ISmaccClient_a926e4f2ae796def63d48dca389a48c47}{stateMachine\_});
52 
53         \hyperlink{classsmacc_1_1ISmaccClient_ab983e85d296c9660f5943c1d511634ce}{components\_}[componentkey] = ret; \textcolor{comment}{//
      std::dynamic\_pointer\_cast<smacc::ISmaccComponent>(ret);}
54         ROS\_DEBUG(\textcolor{stringliteral}{"%s resource is required. Done."}, tname.c\_str());
55     \}
56     \textcolor{keywordflow}{else}
57     \{
58         ROS\_DEBUG(\textcolor{stringliteral}{"%s resource is required. Found resource in cache."}, 
      demangledTypeName<SmaccComponentType>().c\_str());
59         ret = dynamic\_pointer\_cast<SmaccComponentType>(it->second);
60     \}
61 
62     \textcolor{keywordflow}{return} ret.get();
63 \}
\end{DoxyCode}
...
Definition at line 22 of file smacc\+\_\+client\+\_\+impl.\+h.
