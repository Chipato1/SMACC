...
\begin{DoxyCode}
264 \{
265     \hyperlink{classsmacc_1_1SmaccStateMachineInfo_a8d6f1a9ce60f39835e7aa2179139977f}{states}[state->fullStateName] = state;
266 \}
\end{DoxyCode}
...
Definition at line 233 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
234 \{
235     \textcolor{keyword}{auto} initialState = this->createState<InitialStateType>(\textcolor{keyword}{nullptr});
236     \hyperlink{structsmacc_1_1WalkStatesExecutor_a11a2b02eafb62ec298bcf5ffbb32848b}{WalkStatesExecutor<InitialStateType>::walkStates}(
...
Definition at line 240 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
241 \{
242     \textcolor{keyword}{auto} thisptr = this->shared\_from\_this();
243     \textcolor{keyword}{auto} state = std::shared\_ptr<SmaccStateInfo>(\textcolor{keyword}{new} SmaccStateInfo(parent, thisptr));
244     state->demangledStateName = demangledTypeName<StateType>();
245     state->fullStateName = \textcolor{keyword}{typeid}(StateType).name();
246 
247     std::vector<std::string> strs;
248     boost::split(strs, state->demangledStateName, boost::is\_any\_of(\textcolor{stringliteral}{":"}));
249 
250     state->demangledStateName = strs.back();
251 
252     \textcolor{keywordflow}{if} (parent != \textcolor{keyword}{nullptr})
253     \{
254         parent->children\_.push\_back(state);
255     \}
256 
257     this->\hyperlink{classsmacc_1_1SmaccStateMachineInfo_a188e81067d4a693ce479518dc87cf89b}{addState}(state);
258 
259     \textcolor{keywordflow}{return} state;
260 \}
\end{DoxyCode}
