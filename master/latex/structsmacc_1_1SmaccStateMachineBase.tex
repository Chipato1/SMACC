...
\begin{DoxyCode}
46     \{
47         \hyperlink{classsmacc_1_1ISmaccStateMachine_af79fbc17f064bba77e598f5e55a86200}{ISmaccStateMachine::EStop}();
48         this->terminate();
49     \}
\end{DoxyCode}
...
\begin{DoxyCode}
53     \{
54         ROS\_INFO(\textcolor{stringliteral}{"initiate\_impl"});
55         \textcolor{keyword}{auto} shortname = \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(DerivedStateMachine));
56         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8c9c79ca6cd77c975f5d9cda33a6d5e}{onInitializing}(shortname);
57 
58         ROS\_INFO(\textcolor{stringliteral}{"Introspecting state machine via typeWalker"});
59         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_} = std::make\_shared<SmaccStateMachineInfo>();
60         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->buildStateMachineInfo<InitialStateType>();
61 
62         ROS\_INFO(\textcolor{stringliteral}{"Initializing ROS communication mechanisms"});
63         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->assembleSMStructureMessage(\textcolor{keyword}{this});
64         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a95e7f71d0d88fffd0afebb1f9ccdade5}{onInitialized}();
65 
66         ROS\_INFO(\textcolor{stringliteral}{"Initializing state machine"});
...
\begin{DoxyCode}
33     \{
34         \hyperlink{classsmacc_1_1ISmaccStateMachine_a73d50cda0e1bee05812186bf57d6190e}{ISmaccStateMachine::Reset}();
35         this->terminate();
...
\begin{DoxyCode}
40     \{
41         \hyperlink{classsmacc_1_1ISmaccStateMachine_a45032346275dcc8e23abece4d524ca3c}{ISmaccStateMachine::Stop}();
42         this->terminate();
43     \}
\end{DoxyCode}
