...
Definition at line 29 of file smacc\+\_\+orthogonal\+\_\+impl.\+h.



References smacc\+::demangle\+Type().


\begin{DoxyCode}
30 \{
31     static\_assert(std::is\_base\_of<Orthogonal, TObjectTag>::value, \textcolor{stringliteral}{"The object Tag must be the orthogonal
       type where the client was created"});
32     \textcolor{keywordflow}{if}(\textcolor{keyword}{typeid}(*\textcolor{keyword}{this}) != \textcolor{keyword}{typeid}(TObjectTag))
33     \{
34         ROS\_ERROR\_STREAM(\textcolor{stringliteral}{"Error creating client. The object Tag must be the type of the orthogonal where
       the client was created:"} << \hyperlink{namespacesmacc_a792e7a3ea0843e87543a465b446ae730}{demangleType}(\textcolor{keyword}{typeid}(*\textcolor{keyword}{this})) << \textcolor{stringliteral}{". The object creation was skipped and
       a nullptr was returned"});
35         \textcolor{keywordflow}{return} \textcolor{keyword}{nullptr};
36     \}
37     
38     ROS\_INFO(\textcolor{stringliteral}{"[%s] creates a client of type '%s' and object tag '%s'"},
39              \hyperlink{namespacesmacc_a792e7a3ea0843e87543a465b446ae730}{demangleType}(\textcolor{keyword}{typeid}(*\textcolor{keyword}{this})).c\_str(),
40              demangledTypeName<TClient>().c\_str(),
41              demangledTypeName<TObjectTag>().c\_str());
42 
43     \textcolor{keyword}{auto} client = std::make\_shared<TClient>(args...);
44     client->setStateMachine(\hyperlink{classsmacc_1_1Orthogonal_acea2058ac94667e46fc60ed3d4f524f7}{stateMachine\_});
45 
46     client->template configureEventSourceTypes<TObjectTag, TClient>();
47     EventFactory<TClient, TObjectTag> eventfactory;
48 
49     \hyperlink{classsmacc_1_1Orthogonal_a361fd1c4a5b0e6eadd55e919c19969cc}{clients\_}.push\_back(client);
50     \textcolor{keywordflow}{return} client;
51 \}
\end{DoxyCode}
...
\begin{DoxyCode}
68 \{
69     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &client : \hyperlink{classsmacc_1_1Orthogonal_a361fd1c4a5b0e6eadd55e919c19969cc}{clients\_})
70     \{
71         storage = \textcolor{keyword}{dynamic\_cast<}SmaccClientType *\textcolor{keyword}{>}(client.get());
...
\begin{DoxyCode}
55 \{
56     \textcolor{keywordflow}{if} (\hyperlink{classsmacc_1_1Orthogonal_acea2058ac94667e46fc60ed3d4f524f7}{stateMachine\_} == \textcolor{keyword}{nullptr})
57     \{
58         ROS\_ERROR(\textcolor{stringliteral}{"Cannot use the requiresComponent funcionality from an orthogonal before onInitialize"});
59     \}
60     \textcolor{keywordflow}{else}
61     \{
62         \hyperlink{classsmacc_1_1Orthogonal_acea2058ac94667e46fc60ed3d4f524f7}{stateMachine\_}->\hyperlink{classsmacc_1_1ISmaccStateMachine_aa6b25e28f3bce24c4b356dc865a9eb7b}{requiresComponent}(storage);
63     \}
64 \}
\end{DoxyCode}
