...
Definition at line 26 of file odom\+\_\+tracker.\+h.


\begin{DoxyCode}
26                        : uint8\_t \{
27     \hyperlink{namespacesmacc__odom__tracker_ade9730dd5cc10ccfad9362176cf46c33a989d06a586bcf9520889228da7faa643}{RECORD\_PATH\_FORWARD} = 0,
28     \hyperlink{namespacesmacc__odom__tracker_ade9730dd5cc10ccfad9362176cf46c33a0cf8f27617189e35619df3c18bda6274}{CLEAR\_PATH\_BACKWARD} = 1,
29     \hyperlink{namespacesmacc__odom__tracker_ade9730dd5cc10ccfad9362176cf46c33aa5daf7f2ebbba4975d61dab1c40188c7}{IDLE} = 2
30 \};
\end{DoxyCode}
...
\begin{DoxyCode}
126     \{
127         \textcolor{keywordtype}{double} dx = (p1.x - p2.x);
128         \textcolor{keywordtype}{double} dy = (p1.y - p2.y);
129         \textcolor{keywordtype}{double} dz = (p2.z - p2.z);
130         \textcolor{keywordtype}{double} dist = sqrt(dx*dx + dy*dy+dz*dz);
131         \textcolor{keywordflow}{return} dist;
132     \}
\end{DoxyCode}
