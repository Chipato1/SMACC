...
Definition at line 13 of file smacc\+\_\+state\+\_\+base.\+h.
...
Definition at line 18 of file smacc\+\_\+state\+\_\+base.\+h.
...
\begin{DoxyCode}
61   \{
62     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"creatingState state: "} << \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name()).
      c\_str());
63 
64     this->set\_context(\hyperlink{namespacesmacc__viewer_1_1xdot_1_1xdot__qt_a9f8d32bd9e568c00c10171dc27e9483a}{ctx}.pContext\_);
65 
66     ros::NodeHandle contextNh = \hyperlink{common_8h_a06e61136ca4cfcec8bc85b07744e6cd6}{optionalNodeHandle}(\hyperlink{namespacesmacc__viewer_1_1xdot_1_1xdot__qt_a9f8d32bd9e568c00c10171dc27e9483a}{ctx}.pContext\_);
67 
68     ROS\_DEBUG(\textcolor{stringliteral}{"context node handle namespace: %s"}, contextNh.getNamespace().c\_str());
69     \textcolor{keywordflow}{if} (contextNh.getNamespace() == \textcolor{stringliteral}{"/"})
70     \{
71       contextNh = ros::NodeHandle(\hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(Context)));
72     \}
73 
74     std::string classname = \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
75 
...
79     MostDerived *test;
80 
81     this->\hyperlink{classsmacc_1_1SmaccState_abc2a2b5e635b0ba09fcb350710b20117}{updateCurrentState}(\textcolor{keyword}{true}, test); \textcolor{comment}{//<MostDerived>}
82 
...
88 
89       \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto} &stateBehaviorsVector : \hyperlink{classsmacc_1_1SmaccStateInfo_ab677bfb55816d8af9fc0871136bff58a}{SmaccStateInfo::staticBehaviorInfo}
      )
90       \{
91         ROS\_INFO\_STREAM(\textcolor{stringliteral}{" - state info: "} << \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(stateBehaviorsVector.first->name(
      )));
92         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : *(stateBehaviorsVector.second))
93         \{
94           ROS\_INFO\_STREAM(\textcolor{stringliteral}{" - substate behavior: "} << \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(bhinfo.behaviorType->
      name()));
95         \}
96       \}
97 
98       \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
99       \textcolor{keyword}{auto} &staticDefinedBehaviors = SmaccStateInfo::staticBehaviorInfo[tindex];
100 
101       ROS\_INFO(\textcolor{stringliteral}{"---- BEGIN STATIC STATE ACTIONS"});
102       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : *staticDefinedBehaviors)
103       \{
104         ROS\_INFO(\textcolor{stringliteral}{"- Creating static substate behavior"});
105         bhinfo.factoryFunction(\textcolor{keyword}{this});
106       \}
107       ROS\_INFO(\textcolor{stringliteral}{"---- END STATIC STATE ACTIONS"});
108     \}
109 
110     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a49e958861b6ddbe9468e39c1919fde92}{onInitialize}();
111 
112     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aab812187ecb452771e91f0003b257cd2}{notifyOnStateEntry}(\textcolor{keyword}{this});
113 
114     \textcolor{comment}{//ROS\_INFO("Not behavioral State");}
115     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
116   \}
\end{DoxyCode}
...
\begin{DoxyCode}
152   \{
153     \textcolor{keyword}{auto} fullname = \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
154     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"exiting state: "} << fullname);
155 
156     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a9c499f2e3df95a9f72731d2d0d1de0e6}{notifyOnStateExit}(\textcolor{keyword}{this});
157 
158     \textcolor{comment}{//this->updateCurrentState<MostDerived>(false);}
159     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a82ca7c69153e86dc5eedf3f909560f3a}{onExit}();
160 
161     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"throwing finish event "} << fullname);
...
Definition at line 240 of file smacc\+\_\+state\+\_\+base.\+h.
...
\begin{DoxyCode}
243   \{
244     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
245         \hyperlink{classsmacc_1_1SmaccState_a1dccb401e1a99031863a21a590d953e6}{shallow\_construct}(pContext, outermostContextBase));
246     base\_type::template deep\_construct\_inner<inner\_initial\_list>(
247         pInnerContext, outermostContextBase);
248   \}
\end{DoxyCode}
...
\begin{DoxyCode}
142   \{
143     \textcolor{keywordflow}{return} \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
144   \}
\end{DoxyCode}
...
\begin{DoxyCode}
127   \{
128     \textcolor{keyword}{auto} smInfo = this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_};
129 
130     \textcolor{keyword}{auto} \hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key} = \textcolor{keyword}{typeid}(MostDerived).name();
131     \textcolor{keywordflow}{if} (smInfo->states.count(\hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key}))
132     \{
133       \textcolor{keywordflow}{return} smInfo->states[\hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key}]->getFullPath();
134     \}
135     \textcolor{keywordflow}{else}
136     \{
137       \textcolor{keywordflow}{return} \textcolor{stringliteral}{"UnknownFullPath"};
138     \}
139   \}
\end{DoxyCode}
...
\begin{DoxyCode}
35   \{
36     \textcolor{keywordflow}{return} base\_type::outermost\_context().getGlobalSMData(name, ret);
37   \}
\end{DoxyCode}
...
\begin{DoxyCode}
147   \{
148     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
149   \}
\end{DoxyCode}
...
\begin{DoxyCode}
53   \{
54     \textcolor{keywordflow}{return} base\_type::outermost\_context();
55   \}
\end{DoxyCode}
...
\begin{DoxyCode}
235   \{
236     \hyperlink{classsmacc_1_1SmaccState_aac23d8a6909f75c5e5fca2a7c09b5368}{deep\_construct}(&outermostContextBase, outermostContextBase);
237   \}
\end{DoxyCode}
...
\begin{DoxyCode}
168   \{
169     \hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad80cdd7bbc9a9f3b221c625754fed1ed}{postEvent}(ev);
170   \}
\end{DoxyCode}
...
\begin{DoxyCode}
48   \{
49     base\_type::outermost\_context().requiresComponent(storage, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}, value, verbose);
50   \}
\end{DoxyCode}
...
\begin{DoxyCode}
42   \{
43     base\_type::outermost\_context().setGlobalSMData(name, value);
44   \}
\end{DoxyCode}
...
\begin{DoxyCode}
253   \{
254     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
255         \textcolor{keyword}{new} MostDerived(\hyperlink{common_8h_af2dcacead80d69b96952496fe413bbfe}{my\_context}(pContext)));
256     outermostContextBase.add(pInnerContext);
257     \textcolor{keywordflow}{return} pInnerContext;
258   \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{static\+\_\+configure(\+Args \&\&...\+args)}{static_configure(Args &&...args)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Most\+Derived, class Context, class Inner\+Initial = mpl\+::list$<$$>$, sc\+::history\+\_\+mode history\+Mode = sc\+::has\+\_\+no\+\_\+history$>$ template$<$typename T\+Orthogonal , typename T\+Behavior , typename... Args$>$ static void {\bf smacc\+::\+Smacc\+State}$<$ Most\+Derived, Context, Inner\+Initial, history\+Mode $>$\+::static\+\_\+configure (
\begin{DoxyParamCaption}
\item[{Args \&\&...}]{args}
\end{DoxyParamCaption}
...
Definition at line 199 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
200   \{
201     \textcolor{keyword}{auto} strorthogonal = \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(TOrthogonal).name());
202     \textcolor{keyword}{auto} strbehavior = \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(TBehavior).name());
203 
204     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Orthogonal "} << strorthogonal << \textcolor{stringliteral}{" -> "} << strbehavior);
205 
206     StateBehaviorInfoEntry bhinfo;
207     bhinfo.factoryFunction = [&](ISmaccState *state) \{
208       \textcolor{keyword}{auto} bh = std::make\_shared<TBehavior>(std::forward<Args>(args)...);
209       state->configure<TOrthogonal>(bh);
210     \};
211 
212     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
213     bhinfo.behaviorType = &(\textcolor{keyword}{typeid}(TBehavior));
214     bhinfo.orthogonalType = &(\textcolor{keyword}{typeid}(TOrthogonal));
215 
216     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1SmaccStateInfo_ab677bfb55816d8af9fc0871136bff58a}{SmaccStateInfo::staticBehaviorInfo}.count(tindex))
217       \hyperlink{classsmacc_1_1SmaccStateInfo_ab677bfb55816d8af9fc0871136bff58a}{SmaccStateInfo::staticBehaviorInfo}[tindex] = std::make\_shared<
      std::vector<StateBehaviorInfoEntry>>();
218 
219     \hyperlink{classsmacc_1_1SmaccStateInfo_ab677bfb55816d8af9fc0871136bff58a}{SmaccStateInfo::staticBehaviorInfo}[tindex]->push\_back(bhinfo);
220   \}
\end{DoxyCode}
...
\begin{DoxyCode}
173   \{
174     \textcolor{keyword}{auto} *finishEvent = \textcolor{keyword}{new} EvStateFinish<MostDerived>();
175     finishEvent->state = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
176     this->\hyperlink{classsmacc_1_1SmaccState_ae0e035e2d4e60f4ad58f08f44261f26c}{postEvent}(finishEvent);
177   \}
\end{DoxyCode}
...
\begin{DoxyCode}
120   \{
121     base\_type::outermost\_context().updateCurrentState(active, test);
122   \}
\end{DoxyCode}
