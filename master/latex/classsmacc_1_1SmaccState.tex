...
Definition at line 360 of file smacc\+\_\+state\+\_\+base.\+h.
...
Definition at line 113 of file smacc\+\_\+state\+\_\+base.\+h.
...
Definition at line 43 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
44   \{
45     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"creatingState state: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name()).
      c\_str());
46     this->set\_context(ctx.pContext\_);
47 
48     \textcolor{comment}{// storing a reference to the parent state}
49     \textcolor{keyword}{auto} &ps = this->\textcolor{keyword}{template} context<Context>();
50     \hyperlink{classsmacc_1_1ISmaccState_ad61db41d8d06a836e7d1dac7767f5695}{parentState\_} = \textcolor{keyword}{dynamic\_cast<}ISmaccState *\textcolor{keyword}{>}(&ps);
51     \hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown} = \textcolor{keyword}{false};
52 
...
54 
55     ros::NodeHandle contextNh = \hyperlink{namespacesmacc_1_1introspection_a8acc3b4146a8b2bb0a9fa4178840e9b9}{optionalNodeHandle}(ctx.pContext\_);
56 
57     ROS\_DEBUG(\textcolor{stringliteral}{"context node handle namespace: %s"}, contextNh.getNamespace().c\_str());
58     \textcolor{keywordflow}{if} (contextNh.getNamespace() == \textcolor{stringliteral}{"/"})
59     \{
60       contextNh = ros::NodeHandle(\hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(Context)));
61     \}
62 
63     std::string classname = \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
64 
65     this->\hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh} = ros::NodeHandle(contextNh.getNamespace() + std::string(\textcolor{stringliteral}{"/"}) + classname);
66 
67     ROS\_DEBUG(\textcolor{stringliteral}{"nodehandle namespace: %s"}, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getNamespace().c\_str());
68 
69     this->\hyperlink{classsmacc_1_1ISmaccState_a0b6c531ca8c446052022308548f55b92}{setParam}(\textcolor{stringliteral}{"created"}, \textcolor{keyword}{true});
70 
71     \textcolor{comment}{// before dynamic onInitialize, we execute the onDefinition behavior configurations}
72     \{
73       ROS\_DEBUG(\textcolor{stringliteral}{"-- STATIC STATE DESCRIPTION --"});
74 
75       \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto} &stateBehaviorsVector : \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a2cc62c6c9dec1a4f5294f8430efb71f2}{SmaccStateInfo::staticBehaviorInfo}
      )
76       \{
77         ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{" - state info: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(stateBehaviorsVector.first->name
      ()));
78         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : stateBehaviorsVector.second)
79         \{
80           ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{" - client behavior: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(bhinfo.behaviorType->name
      ()));
81         \}
82       \}
83 
84       \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
85       \textcolor{keyword}{auto} &staticDefinedBehaviors = SmaccStateInfo::staticBehaviorInfo[tindex];
86       \textcolor{keyword}{auto} &staticDefinedLogicUnits = \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a7a22f3c1ea22042a19f897db4ecfeb67}{SmaccStateInfo::logicUnitsInfo}[tindex];
87 
88       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : staticDefinedBehaviors)
89       \{
90         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static client behavior: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(bhinfo.
      behaviorType->name()));
91         bhinfo.factoryFunction(\textcolor{keyword}{this});
92       \}
93 
94       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &lu : staticDefinedLogicUnits)
95       \{
96         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static logic unit: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(lu.logicUnitType->
      name()));
97         lu.factoryFunction(\textcolor{keyword}{this});
98       \}
99 
100       ROS\_INFO(\textcolor{stringliteral}{"---- END STATIC DESCRIPTION"});
101     \}
102 
103     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a49e958861b6ddbe9468e39c1919fde92}{onInitialize}();
104 
105     \textcolor{comment}{//ROS\_INFO("Not behavioral State");}
106     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
107 
108     \textcolor{comment}{// here orthogonals and client behaviors are entered OnEntry}
109     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a856cf2d25d84659b974cccfbf44aeec9}{notifyOnStateEntryEnd}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
110   \}
\end{DoxyCode}
...
145     \{
146       this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a5c8d4c9a4b11c7950266a00e48080ce3}{lockStateMachine}(\textcolor{stringliteral}{"state exit"});
147       \textcolor{keyword}{auto} fullname = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
148       ROS\_WARN\_STREAM(\textcolor{stringliteral}{"exiting state: "} << fullname);
149       this->\hyperlink{classsmacc_1_1ISmaccState_a0b6c531ca8c446052022308548f55b92}{setParam}(\textcolor{stringliteral}{"destroyed"}, \textcolor{keyword}{true});
150 
151       this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a9d2bd4aca0c80a1ec22c5f95e7c38db8}{notifyOnStateExit}(static\_cast<MostDerived *>(\textcolor{keyword}{
      this}));
152       ROS\_WARN\_STREAM(\textcolor{stringliteral}{"state exit: "} << fullname);
153     \}
154     \textcolor{keywordflow}{catch} (...)
155     \{
156     \}
157     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ae2e3ceb87bfe3f9d8bf320e36071fdc7}{unlockStateMachine}(\textcolor{stringliteral}{"state exit"});
158   \}
\end{DoxyCode}
...
Referenced by smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::initial\+\_\+deep\+\_\+construct().


\begin{DoxyCode}
373   \{
374     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
375         \hyperlink{classsmacc_1_1SmaccState_a1dccb401e1a99031863a21a590d953e6}{shallow\_construct}(pContext, outermostContextBase));
376     base\_type::template deep\_construct\_inner<inner\_initial\_list>(
377         pInnerContext, outermostContextBase);
378   \}
\end{DoxyCode}
...
\begin{DoxyCode}
133   \{
134     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
135   \}
\end{DoxyCode}
...
\begin{DoxyCode}
118   \{
119     \textcolor{keyword}{auto} smInfo = this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_};
120 
121     \textcolor{keyword}{auto} key = \textcolor{keyword}{typeid}(MostDerived).name();
122     \textcolor{keywordflow}{if} (smInfo->states.count(key))
123     \{
124       \textcolor{keywordflow}{return} smInfo->states[key]->getFullPath();
125     \}
126     \textcolor{keywordflow}{else}
127     \{
128       \textcolor{keywordflow}{return} \textcolor{stringliteral}{"UnknownFullPath"};
129     \}
130   \}
\end{DoxyCode}
...
\begin{DoxyCode}
216   \{
217     \textcolor{keywordflow}{return} base\_type::outermost\_context().getGlobalSMData(name, ret);
218   \}
\end{DoxyCode}
...
\begin{DoxyCode}
36   \{
37     \textcolor{comment}{//auto* ctx = dynamic\_cast<ISmaccState*>(this->template context<Context *>());}
38 
39     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccState_ad61db41d8d06a836e7d1dac7767f5695}{parentState\_};
40   \}
\end{DoxyCode}
...
\begin{DoxyCode}
138   \{
139     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
140   \}
\end{DoxyCode}
...
Referenced by smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::get\+Full\+Path\+Name(), smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::\+Smacc\+State(), and smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::$\sim$\+Smacc\+State().


\begin{DoxyCode}
234   \{
235     \textcolor{keywordflow}{return} base\_type::outermost\_context();
236   \}
\end{DoxyCode}
...
\begin{DoxyCode}
365   \{
366     \hyperlink{classsmacc_1_1SmaccState_aac23d8a6909f75c5e5fca2a7c09b5368}{deep\_construct}(&outermostContextBase, outermostContextBase);
367   \}
\end{DoxyCode}
...
\begin{DoxyCode}
261   \{
262     \textcolor{keyword}{using} boost::mpl::\_1;
263     \textcolor{keyword}{using} wrappedList = \textcolor{keyword}{typename} boost::mpl::transform<TEventList, \_1>::type;
264     AddLogicUnitEventType<wrappedList> op(luinfo);
265     boost::mpl::for\_each<wrappedList>(op);
266   \}
\end{DoxyCode}
...
\begin{DoxyCode}
229   \{
230     base\_type::outermost\_context().requiresComponent(storage);
231   \}
\end{DoxyCode}
...
\begin{DoxyCode}
223   \{
224     base\_type::outermost\_context().setGlobalSMData(name, value);
225   \}
\end{DoxyCode}
...
Referenced by smacc\+::\+Smacc\+State$<$ Ms\+Dance\+Bot\+Run\+Mode, Sm\+Dance\+Bot, St\+Acquire\+Sensors $>$\+::deep\+\_\+construct().
...
385 
386         \textcolor{keyword}{new} MostDerived(
387             \hyperlink{classSmaccState}{SmaccState<MostDerived, Context, InnerInitial, historyMode>}
      ::
388 
389                 \hyperlink{common_8h_af2dcacead80d69b96952496fe413bbfe}{my\_context}(pContext)));
390     outermostContextBase.add(pInnerContext);
391     \textcolor{keywordflow}{return} pInnerContext;
392   \}
\end{DoxyCode}
...
\begin{DoxyCode}
192   \{
193     \textcolor{keyword}{auto} strorthogonal = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TOrthogonal).name());
194     \textcolor{keyword}{auto} strbehavior = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TBehavior).name());
195 
196     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Orthogonal "} << strorthogonal << \textcolor{stringliteral}{" -> "} << strbehavior);
197 
198     StateBehaviorInfoEntry bhinfo;
199     bhinfo.factoryFunction = [=](ISmaccState *state) \{
200       \textcolor{comment}{//auto bh = std::make\_shared<TBehavior>(args...);}
201       state->configure<TOrthogonal, TBehavior>(args...);
202     \};
203 
204     bhinfo.behaviorType = &(\textcolor{keyword}{typeid}(TBehavior));
205     bhinfo.orthogonalType = &(\textcolor{keyword}{typeid}(TOrthogonal));
206 
207     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
208     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a2cc62c6c9dec1a4f5294f8430efb71f2}{SmaccStateInfo::staticBehaviorInfo}.count(tindex))
209       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a2cc62c6c9dec1a4f5294f8430efb71f2}{SmaccStateInfo::staticBehaviorInfo}[tindex] = 
      std::vector<StateBehaviorInfoEntry>();
210 
211     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a2cc62c6c9dec1a4f5294f8430efb71f2}{SmaccStateInfo::staticBehaviorInfo}[tindex].push\_back(bhinfo);
212   \}
\end{DoxyCode}
...
\begin{DoxyCode}
270   \{
271     SmaccLogicUnitInfo luinfo;
272 
273     luinfo.logicUnitType = &\textcolor{keyword}{typeid}(TLUnit);
274 
275     std::string eventtypename = \textcolor{keyword}{typeid}(TTriggerEvent).name();
276     \textcolor{keyword}{auto} eventType = \hyperlink{classsmacc_1_1introspection_1_1TypeInfo_a47d65b6c61499d7ae8ab9f6325c84837}{TypeInfo::getTypeInfoFromString}(eventtypename);
277 
278     \textcolor{keywordflow}{if} (eventType->templateParameters.size() > 1)
279     \{
280       luinfo.objectTagType = eventType->templateParameters[1];
281     \}
282     \textcolor{keywordflow}{else}
283     \{
284       luinfo.objectTagType = \textcolor{keyword}{nullptr};
285     \}
286 
287     iterateLogicUnitEventTypes<TEventList>(luinfo);
288 
289     luinfo.factoryFunction = [&, args...](ISmaccState *state) \{
290       \textcolor{keyword}{auto} lu = state->createLogicUnit<TLUnit, TTriggerEvent, TEventList>(args...);
291       \textcolor{keywordflow}{return} lu;
292     \};
293 
294     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
295     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a7a22f3c1ea22042a19f897db4ecfeb67}{SmaccStateInfo::logicUnitsInfo}.count(tindex))
296       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a7a22f3c1ea22042a19f897db4ecfeb67}{SmaccStateInfo::logicUnitsInfo}[tindex] = 
      std::vector<SmaccLogicUnitInfo>();
297 
298     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a7a22f3c1ea22042a19f897db4ecfeb67}{SmaccStateInfo::logicUnitsInfo}[tindex].push\_back(luinfo);
299   \}
\end{DoxyCode}
...
\begin{DoxyCode}
161   \{
162     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown})
163     \{
164       \textcolor{keyword}{auto} *finishEvent = \textcolor{keyword}{new} EvStateFinish<MostDerived>();
165       finishEvent->state = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
166       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(finishEvent);
167       \hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown} = \textcolor{keyword}{true};
168     \}
169   \}
\end{DoxyCode}
...
Definition at line 333 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
334   \{
335     \textcolor{keyword}{auto} *thisobject = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
336     \textcolor{keyword}{auto} condition = boost::bind(conditionFn, thisobject);
337     \textcolor{keywordtype}{bool} conditionResult = condition();
338     \textcolor{comment}{//ROS\_INFO("LOOP EVENT CONDITION: %d", conditionResult);}
339     \textcolor{keywordflow}{if} (conditionResult)
340     \{
341       \textcolor{keyword}{auto} evloopcontinue = \textcolor{keyword}{new} EvLoopContinue<MostDerived>();
342       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(evloopcontinue);
343     \}
344     \textcolor{keywordflow}{else}
345     \{
346       \textcolor{keyword}{auto} evloopend = \textcolor{keyword}{new} EvLoopEnd<MostDerived>();
347       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(evloopend);
348     \}
349     ROS\_INFO(\textcolor{stringliteral}{"POST THROW CONDITION"});
350   \}
\end{DoxyCode}
