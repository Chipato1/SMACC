...
Definition at line 59 of file smacc\+\_\+state\+\_\+base.\+h.
...
71 
72     ROS\_DEBUG(\textcolor{stringliteral}{"context node handle namespace: %s"}, contextNh.getNamespace().c\_str());
...
81 
82     ROS\_DEBUG(\textcolor{stringliteral}{"nodehandle namespace: %s"}, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getNamespace().c\_str());
83 
...
94       \textcolor{comment}{//   \{}
95       \textcolor{comment}{//     ROS\_INFO\_STREAM(" - client behavior: " << demangleSymbol(bhinfo.behaviorType->name()));}
96       \textcolor{comment}{//   \}}
97       \textcolor{comment}{// \}}
98 
99       \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
100       \textcolor{keyword}{auto} &staticDefinedBehaviors = \hyperlink{classsmacc_1_1SmaccStateInfo_a2cc62c6c9dec1a4f5294f8430efb71f2}{SmaccStateInfo::staticBehaviorInfo}[
      tindex];
101       \textcolor{keyword}{auto} &staticDefinedLogicUnits = \hyperlink{classsmacc_1_1SmaccStateInfo_a7a22f3c1ea22042a19f897db4ecfeb67}{SmaccStateInfo::logicUnitsInfo}[tindex];
102 
103       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : staticDefinedBehaviors)
104       \{
105         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static client behavior: "} << \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(bhinfo.
      behaviorType->name()));
106         bhinfo.factoryFunction(\textcolor{keyword}{this});
107       \}
108 
109       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &lu : staticDefinedLogicUnits)
110       \{
111         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static logic unit: "} << \hyperlink{namespacesmacc_a458f5e70d468824fbcd66cc7729deaa8}{demangleSymbol}(lu.logicUnitType->
      name()));
112         lu.factoryFunction(\textcolor{keyword}{this});
113       \}
114 
115       ROS\_INFO(\textcolor{stringliteral}{"---- END STATIC DESCRIPTION"});
116     \}
117 
118     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a49e958861b6ddbe9468e39c1919fde92}{onInitialize}();
119 
120     \textcolor{comment}{//ROS\_INFO("Not behavioral State");}
121     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
122 
123     \textcolor{comment}{// here orthogonals and client behaviors are entered OnEntry}
124     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a856cf2d25d84659b974cccfbf44aeec9}{notifyOnStateEntryEnd}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
125   \}
\end{DoxyCode}
...
\begin{DoxyCode}
46   \{
47     base\_type::outermost\_context().requiresComponent(storage);
48   \}
\end{DoxyCode}
