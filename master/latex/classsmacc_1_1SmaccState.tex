...
Definition at line 181 of file smacc\+\_\+state\+\_\+base.\+h.
...
Definition at line 179 of file smacc\+\_\+state\+\_\+base.\+h.
...
82 
83     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a49e958861b6ddbe9468e39c1919fde92}{onInitialize}();
84 
85     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aab812187ecb452771e91f0003b257cd2}{notifyOnStateEntry}(\textcolor{keyword}{this});
86 
87     \textcolor{comment}{//ROS\_INFO("Not behavioral State");}
88     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
89     
90   \}
\end{DoxyCode}
...
\begin{DoxyCode}
126   \{
127     \textcolor{keyword}{auto} fullname = \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
128     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"exiting state: "} << fullname);
129 
130     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a9c499f2e3df95a9f72731d2d0d1de0e6}{notifyOnStateExit}(\textcolor{keyword}{this});
131 
132     \textcolor{comment}{//this->updateCurrentState<MostDerived>(false);}
133     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a82ca7c69153e86dc5eedf3f909560f3a}{onExit}();    
134 
135     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"throwing finish event "} << fullname);
136     this->\hyperlink{classsmacc_1_1SmaccState_a56ccdfaf818ed6409dcbd4ab8b01c60e}{throwFinishEvent}();
137     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"state exit: "} << fullname);
138   \}
\end{DoxyCode}
...
\begin{DoxyCode}
194   \{
195     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
196         \hyperlink{classsmacc_1_1SmaccState_a1dccb401e1a99031863a21a590d953e6}{shallow\_construct}(pContext, outermostContextBase));
197     base\_type::template deep\_construct\_inner<inner\_initial\_list>(
198         pInnerContext, outermostContextBase);
199   \}
\end{DoxyCode}
...
\begin{DoxyCode}
116   \{
117     \textcolor{keywordflow}{return} \hyperlink{common_8h_a401d7e4f000fd4246a20be1e7d5ec2fc}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
118   \}
\end{DoxyCode}
...
Definition at line 100 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
101   \{
102     \textcolor{keyword}{auto} smInfo = this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_};
103 
104     \textcolor{keyword}{auto} \hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key} = \textcolor{keyword}{typeid}(MostDerived).name();
105     \textcolor{keywordflow}{if} (smInfo->states.count(\hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key}))
106     \{
107       \textcolor{keywordflow}{return} smInfo->states[\hyperlink{namespacekeyboard__node_aec12217d2be0bbc768f52b63b0673925}{key}]->getFullPath();
108     \}
109     \textcolor{keywordflow}{else}
110     \{
111       \textcolor{keywordflow}{return} \textcolor{stringliteral}{"UnknownFullPath"};
112     \}
113   \}
\end{DoxyCode}
...
\begin{DoxyCode}
121   \{
122     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_a09b297b1cdb9aae93a958f323431464a}{cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
123   \}
\end{DoxyCode}
...
\begin{DoxyCode}
186   \{
187     \hyperlink{classsmacc_1_1SmaccState_aac23d8a6909f75c5e5fca2a7c09b5368}{deep\_construct}(&outermostContextBase, outermostContextBase);
188   \}
\end{DoxyCode}
...
\begin{DoxyCode}
142   \{
143     \hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad80cdd7bbc9a9f3b221c625754fed1ed}{postEvent}(ev);
144   \}
\end{DoxyCode}
...
\begin{DoxyCode}
204   \{
205     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
206         \textcolor{keyword}{new} MostDerived(\hyperlink{common_8h_af2dcacead80d69b96952496fe413bbfe}{my\_context}(pContext)));
207     outermostContextBase.add(pInnerContext);
208     \textcolor{keywordflow}{return} pInnerContext;
209   \}
\end{DoxyCode}
...
\begin{DoxyCode}
147   \{
148     \textcolor{keyword}{auto} *finishEvent = \textcolor{keyword}{new} EvStateFinish<MostDerived>();
149     finishEvent->state = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
150     this->\hyperlink{classsmacc_1_1SmaccState_ae0e035e2d4e60f4ad58f08f44261f26c}{postEvent}(finishEvent);
151   \}
\end{DoxyCode}
...
\begin{DoxyCode}
94   \{
95     base\_type::outermost\_context().updateCurrentState(active, test);
96   \}
\end{DoxyCode}
