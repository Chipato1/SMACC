...
References smacc\+::demangle\+Type(), smacc\+::\+I\+Smacc\+State\+Machine\+::get\+Orthogonals(), smacc\+State\+Machine\+\_\+, and updatable\+Client\+Behaviors\+\_\+.
...
74         \textcolor{keyword}{auto} *currentBehavior = orthogonal->getCurrentBehavior();
75 
76         \textcolor{keywordflow}{if} (currentBehavior == \textcolor{keyword}{nullptr})
77             \textcolor{keywordflow}{continue};
78 
79         ISmaccUpdatable *updatableClientBehavior = \textcolor{keyword}{dynamic\_cast<}ISmaccUpdatable *\textcolor{keyword}{>}(currentBehavior);
80 
81         \textcolor{keywordflow}{if} (updatableClientBehavior != \textcolor{keyword}{nullptr})
82         \{
83             ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"Adding updatable behavior: "} << \hyperlink{namespacesmacc_a792e7a3ea0843e87543a465b446ae730}{demangleType}(\textcolor{keyword}{typeid}(
      updatableClientBehavior)));
84             this->\hyperlink{classsmacc_1_1SignalDetector_a777b671ca6bbedd2fdc83f60f9ec8f83}{updatableClientBehaviors\_}.push\_back(updatableClientBehavior);
85         \}
86     \}
87 \}
\end{DoxyCode}
...
179                     ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"pollOnce update client behavior call: "} << 
      \hyperlink{namespacesmacc_a792e7a3ea0843e87543a465b446ae730}{demangleType}(\textcolor{keyword}{typeid}(*updatableBehavior)));
