...
\begin{center}
\leavevmode
\includegraphics[width=253pt]{classsm__dance__bot_1_1TimerOrthogonal__inherit__graph}
\end{center}
\end{figure}
...
\begin{DoxyCode}
11     \{
12         \textcolor{keyword}{auto} *actionclient = this->createClient<ros\_timer\_client::SmaccTimerClient>(ros::Duration(0.5));
