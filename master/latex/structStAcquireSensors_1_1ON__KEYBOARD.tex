...
\begin{center}
\leavevmode
\includegraphics[width=196pt]{structStAcquireSensors_1_1ON__KEYBOARD__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=196pt]{structStAcquireSensors_1_1ON__KEYBOARD__coll__graph}
\end{center}
\end{figure}
