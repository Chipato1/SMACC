...
\begin{DoxyCode}
16     \{
17         \textcolor{comment}{//   static\_configure<ObstaclePerceptionOrthogonal, CbLidarSensor>();}
18         \textcolor{comment}{//   static\_configure<PublisherOrthogonal, CbStringPublisher>("Hello World!");}
19         \textcolor{comment}{//   static\_configure<SensorOrthogonal, CbConditionTemperatureSensor>();}
20         \textcolor{comment}{//   static\_configure<Service3Orthogonal, Service3Behavior>(Service3Command::SERVICE3\_ON);}
21 
